...
public class RepositoryPersonService implements PersonService {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<Person> findByLastNameOrderByDesc() {
        LOGGER.debug("Finding all persons findByNameOrderByDesc");
        //Passes the Sort object to the repository.
        return personRepository.findAll(new Sort(Sort.Direction.DESC, "lastName"));
    }
